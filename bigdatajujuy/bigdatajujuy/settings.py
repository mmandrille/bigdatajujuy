"""
Django settings for bigdatajujuy project.
...
SECRET_KEY = '_dp1os$lxtbke64jtgbkja9edx7^$w%sg)ysxf%pdc3#m1pf)@'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'bigdata.jujuydigital.com.ar',]
...
ROOT_URLCONF = 'bigdatajujuy.urls'
...
WSGI_APPLICATION = 'bigdatajujuy.wsgi.application'
